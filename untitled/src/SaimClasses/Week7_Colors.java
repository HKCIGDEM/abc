...
T1ColorPicker [loop, Scanner, String]
    ...
    // our program can only handle one shape of each color
    ...
    public static void main(String[] args) {
        ...
        while ( colors <= 3) { // dark blue
            System.out.println(" Enter color: " + colors);
            String currentColor = input.nextLine().toLowerCase().trim();   // light blue
