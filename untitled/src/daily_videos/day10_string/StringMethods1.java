...
public class StringMethods1 {
    public static void main(String[] args) {
       ...
       int length = sentence.length();
        ...
        String j1 ="Java is the best programming language";

        char ft = j1.charAt(0);

        int lstIndexNum = j1.length() - 1;

        char lst = j1.charAt(lstIndexNum);

        System.out.println(ft +" : "+lst);
        ...
        if (age >= 21 && answer.equals("yes") ){
            ...
            input.close();// YAZMAYI UNUTMA YOKSA BITMIS OLMUYOR!!!!!!!!!!!!!!!!
        }
